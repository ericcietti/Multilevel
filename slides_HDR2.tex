...
$$
\widehat{x} \in\underset{x}{\arg\min}\; \underbrace{\frac{1}{2}\Vert \alert{A} x - z \Vert_2^2}_{L} + \underbrace{\lambda \sum_i\| (\alert{D} x)(i)\|_\star}_{S}
$$
...
$$
\min_x f_i^H(x)=\frac{1}{2}\|\alert{R}(A x-z)\|^2
$$
\end{frame}
...
\end{tcolorbox}
 ...
 \item  Solve $H(x_i)d_i \approx -g_i$     in \textcolor{myblue!70!black}{$u_H$} \\
